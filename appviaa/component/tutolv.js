...
export default class tutolv extends React.Component {
    ...
    render() {
        return (
            <View>
                <Text style= {{textAlign: 'center', marginTop: 30, fontSize: 20, fontWeight: '900'}}>Laipni lūdzam</Text>
            ...
            borderWidth: 1, width: width/1.5, left: width/6}}
                ...
                placeholder = "Izvēlieties savas komandas nosaukumu"
                placeholderTextColor = "#black"
                autoCapitalize = "none"
                onChangeText = {this.handleTeam}/>
            <TouchableOpacity style= {{top: 10, borderColor: 'black',
            borderWidth: 1, width: width/1.5, left: width/6}} onPress={() => this.props.navigation.navigate('scorelv', {team: this.state.team})}>
                <View>
