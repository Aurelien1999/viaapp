...
export default class sending extends React.Component {
    ...
    render() {
        return (
            <View>
                <Text style= {{textAlign: 'center', top: 90, fontSize: 25, fontWeight: '900'}}>Resume what you choose : </Text>
                <Text style= {{textAlign: 'center', top: 100, fontSize: 25}}>Game : {this.state.game == "" ? "Elvin Assin" : this.state.game}</Text>
                <Text style= {{textAlign: 'center', top: 110, fontSize: 25}}>Score : {this.state.score}</Text>
                <Text style= {{textAlign: 'center', top: 120, fontSize: 25}}>Team name : {this.state.team}</Text>
            ...
            borderWidth: 1, width: width/1.5, left: width/6}}>
                    ...
                    <View>
                        <Text style={{textAlign: "center"}}>Sending data to API</Text>
                    </View>
                </TouchableOpacity>
                <Text style = {{fontWeight: "900", textAlign: 'center', top :265, color: 'red'}}>No API yet
                </Text>
