...
export default class score extends React.Component {
    ...
    render() {
        return (
            <View>
                <Text style = {{textAlign: 'center', fontSize: 25, fontWeight: "900", top :40}}>Welcome team {this.props.route.params.team}</Text>
                <Picker
            ...
            borderWidth: 1, width: width/1.5, left: width/6}} onPress={() => this.props.navigation.navigate('sending', {team: this.state.team, game: this.state.game, score: this.state.score})}>
                    <View>
